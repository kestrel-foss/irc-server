...
```bash
/opt/perl-5.42/bin/perl overnet-program-irc/bin/overnet-irc-local-server.pl
```
...
```bash
/opt/perl-5.42/bin/perl overnet-program-irc/bin/overnet-irc-chat-client.pl --nick alice
/opt/perl-5.42/bin/perl overnet-program-irc/bin/overnet-irc-chat-client.pl --nick bob
```
